...
public class InvalidUsernameAndInvalidPassword {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        d.findElement(By.xpath("//input[@name='password']")).sendKeys("Tipathi1@");
        ...
        d.findElement(By.xpath("//div[text()='Login']")).click();
        Thread.sleep(2000);
        String actualErrorMessage1 = d.findElement(By.xpath("//div[@class='header']")).getText();
        System.out.println(actualErrorMessage1);
        boolean  flag1 = actualErrorMessage.equals(expectedErrorMessage);
        if (flag1 == false)
            System.exit(1);
